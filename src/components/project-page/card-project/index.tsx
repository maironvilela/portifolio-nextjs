...
type CardProjectProps = Projects;

export function CardProject({ title, subTitle, descriptions, projectUrl, technologies, image }: CardProjectProps) {


    return (
        <AnimationEase className="flex gap-4 flex-col relative  rounded-3xl md:static  
